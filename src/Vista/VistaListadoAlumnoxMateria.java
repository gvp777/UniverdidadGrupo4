...
public class VistaListadoAlumnoxMateria extends javax.swing.JInternalFrame {
    ...
    private Materia materiaSeleccioada;
    ...
    //--------------------------------------------------------------------------   
    private void cargarTablaConAlumnosInscriptos(){
        String nota;
        borrarFilas();
        
        materiaSeleccioada = (Materia) jcbxMaterias.getSelectedItem();               
        ...
        for( Cursada listMatCursIt : listaMateriasQueSonCusadas){
            ...
            if(materiaSeleccioada != null ){
                if( listMatCursIt.getMateria().getId() == materiaSeleccioada.getId() ){
